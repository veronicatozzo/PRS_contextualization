...
# Get Incidence 
~/miniconda3/envs/py37/bin/python3.7 utils/cases_controls_incidence.py get_cases_controls \
...
# Get Prevalence
~/miniconda3/envs/py37/bin/python3.7 utils/cases_controls_prevalence.py get_cases_controls \
    --encounters_file $encounters_file \
    --bmi_file $bmi_file \
    --dem_file $dem_file \
